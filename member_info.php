            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    ...
                    <form action="member_mod.php"  method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control" id="floatingText" value="<?php echo $_SESSION["userpw"]?>" readonly>
                                <label for="floatingText">PW</label>   
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingText" value="<?php echo $_SESSION["username"]?>" readonly>
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingText" value="<?php echo $_SESSION["phone"]?>" readonly>
                                 <label for="floatingText">Phone Number</label>   
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingText" value="<?php echo $_SESSION["email"]?>" readonly>
                        ...
                        <button type="submit" class="btn btn-primary py-3 w-100 mb-5">회원정보 수정</button>
                    </form>

...
<body>
    ...
    <section class="details-hero-section set-bg" data-setbg="img/details/lost_main.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="details-hero-text">
                        ...
                        <h3>로스트아크</h3>
                        <ul>
                            <li>개발: <span>스마일 게이트</span></li>
                            <li><i class="fa fa-clock-o"></i>출시일: 2019년 12월 4일</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 p-0">
                    <div class="details-text">
                        <div class="dt-desc">
                            <P>게임 설명</P>
                            <p>《로스트아크》(Lost Ark←잃어버린 방주)는 대한민국의 비디오 게임 기업 스마일게이트RPG가 개발·배급하는 온라인 MMORPG(대규모 다중 사용자 온라인 롤플레잉 게임)이다.<br><br>
                                트라이포드 스튜디오에서 개발하고 스마일게이트 RPG가 운영하는 쿼터뷰 액션 MMORPG. <br>
                                2014년 11월 12일에 최초 공개되었으며, 2018년 11월 7일부터 국내에서 오픈 베타 테스트를 진행하였고, <br>
                                이후 2019년 12월 4일에 정식 오픈하였으며, 
                                2020년 8월 12일부터 시즌 2가 시작되었고
                                러시아, 일본, 북미/유럽, 중국 서비스를 개시하였다.
                            </p>
                        </div>
                                    ...
                                    <div class="or-loader">
                                        <div class="loader-circle-wrap">
                                            <div class="loader-circle">
                                                <span class="circle-progress-2" data-cpid="id-5" data-cpvalue="4.2"
                    ...
                    <div class="sidebar-option">
                        <div class="social-media">
                            <div class="section-title">
                                <h5>로스트아크 Social media</h5>
                            </div>
                            <ul>
                                <li>
                                    <div class="sm-icon"><i class="fa fa-facebook"></i></div>
                                    <span><a href="https://www.facebook.com/LOSTARK.official" style="color:white"target="_blank">Facebook</a></span>
                                    <div class="follow">좋아요 3.9만개</div>
                                </li>
                                <li>
                                    <div class="sm-icon"><i class="fa fa-twitter"></i></div>
                                    <span><a href=""style="color:white"target="_blank">Twitter</a></span>
                                    <div class="follow">no data</div>
                                </li>
                                <li>
                                    <div class="sm-icon"><i class="fa fa-youtube-play"></i></div>
                                    <span><a href=" http://rb.gy/wcrrs"style="color:white"target="_blank">Youtube</a></span>
                                    <div class="follow">22.8만 구독자</div>
                                </li>
                                <li>
